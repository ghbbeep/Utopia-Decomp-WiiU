...
namespace Sonic
{
	...
	public class CharacterStatePeelout : CharacterState
	{
		...
		public override void OnStateUpdate()
		{
			...
			defaultMotionData.freeAcceleration = ((substate != Substate.Charge) ? base.character.GetAttributeValue("Free Acceleration") : 0f);
			...
			defaultMotionData.groundDeceleration = base.character.GetAttributeValue((substate != Substate.Charge) ? "Ground Deceleration" : "Ground Brake");
