...
namespace Sonic
{
	...
	public class CharacterStateRoll : CharacterState
	{
		...
		public override void OnStateUpdate()
		{
			...
			RaycastHit hitInfo;
			if ((bool)base.motor && base.motor.drive.magnitude > 0.1f && substate != Substate.Crouch && base.motor.rigidbody.SweepTest(base.motor.velocity, out hitInfo, base.motor.velocity.magnitude * Time.fixedDeltaTime * impactDetectionBuffer))
			{
