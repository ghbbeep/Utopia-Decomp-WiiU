...
namespace Sonic
{
	public class PlayerPref : MonoBehaviour
	{
		...
		public void Apply()
		{
			...
			float num = PlayerPrefs.GetFloat("View Sensitivity", 1f);
			userViewControls.mouseSensitivity = new Vector3(num * 0.1f, num * 0.1f, 1f);
			userViewControls.viewSensitivity = new Vector3(num, num, 1f);
